...
create_module_templates()
{
	...
	cp -r "../ModuleArchitecture/Templates/${PREFIX_NAME}/" "./${MODULE_NAME}.xctemplate/${TEMPLATE_CONFIGURATION}"
	...
	LIBRARY_PATH="${HOME}/Library/Developer/Xcode/Templates/File Templates/99"
